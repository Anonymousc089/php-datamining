...
Route::group([
    ...
    Route::prefix('admin')->group(function () {
        Route::prefix('data-training')->group(function () {
            ...
            Route::delete('/hapusin', 'DataTrainingController@destroy');
        ...
        Route::prefix('data-testing')->group(function () {
            ...
            Route::delete('/hapusin', 'DataTestingController@destroy');
            Route::post('/import', 'DataTestingController@import')->name('data-testing-import');
        });
        Route::prefix('statistik')->group(function () {
            Route::get('/a', 'StatistikController@index')->name('statistik.index');
            Route::get('/', 'StatistikController@count');
        });
    });
});
Auth::routes();
